...
urlpatterns = [
    ...
    path('users/page/<int:page>/', adminapp.users, name = 'users_page'),
    ...
    path('categories/page/<int:page>/', adminapp.categories, name = 'categories_page'),
    ...
    path('products/category/<int:pk>/page/<int:page>/', adminapp.products, name = 'products_page'),
]